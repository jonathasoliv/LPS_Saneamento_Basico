...
public class ClienteController {
    ...
    public void cadastrarCliente(String nome, String sexo, int idade, String dataNascimento, String endereco, String email, String senha, String telefone, String cidade, String bairro, String unidadeConsumidora) {
        ValidateCliente valid = new ValidateCliente();
        Cliente novoCliente = valid.validaCamposEntrada(nome, sexo, idade, dataNascimento, endereco, email, senha, telefone, cidade, bairro, unidadeConsumidora);
    ...
    public void atualizarCliente(int idCliente, String nome, String sexo, int idade, String dataNascimento, String endereco, String email, String senha, String telefone, String cidade, String bairro, String unidadeConsumidora) {
        ValidateCliente valid = new ValidateCliente();
        Cliente novoCliente = valid.validaCamposEntrada(nome, sexo, idade, dataNascimento, endereco, email, senha, telefone, cidade, bairro, unidadeConsumidora);
