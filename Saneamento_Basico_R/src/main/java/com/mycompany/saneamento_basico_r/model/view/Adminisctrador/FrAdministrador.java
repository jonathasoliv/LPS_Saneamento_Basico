...
public class FrAdministrador extends javax.swing.JDialog {
    ...
    public FrAdministrador(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    ...
    private void btnUsuarioLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUsuarioLoginActionPerformed
        FrAdministradorFuncoes dlgAdminFuncoes = new FrAdministradorFuncoes(this, true);
        
        dlgAdminFuncoes.setLocationRelativeTo(this);
        dlgAdminFuncoes.setVisible(true);
